	...
	var FormInput = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('input', { type: 'text', ref: 'name', placeholder: 'enter message' }),
	...
	var Main = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(MessageBox, { name: name, message: message }),
	      React.createElement(FormInput, { onNewName: this.updateName, onNewMessage: this.updateMessage })
	    );
	  }
	});
